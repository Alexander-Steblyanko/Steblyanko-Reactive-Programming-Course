...
public class Task {
	...
	public static Flux<IceCreamBall> fillIceCreamWaffleBowl(Flux<IceCreamType> clientPreferences,
		...
		return clientPreferences.switchMap(p -> {
			if (p == IceCreamType.VANILLA) { return vanillaIceCreamStream; }
			else if (p == IceCreamType.CHOCOLATE) { return chocolateIceCreamStream; }
